...
public abstract class Employee {
    ...
    public Employee(String nameIn, String ssnIn){
        // initialze fields in our object
        this.name = nameIn;
        this.ssn = ssnIn;
        // print out so we know this constructor runs
        System.out.println("Employee: Constructor(String String");
    }
    //provide default constructor for this class in case any of our derived classes
...
//    
    ...
    //abstract means that all derived classes MUST provide an implemenation 
    //for this method
