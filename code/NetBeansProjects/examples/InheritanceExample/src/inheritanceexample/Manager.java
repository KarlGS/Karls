...
public class Manager extends Employee {
    ...
    // since Employee does not have a  default constructor
    ...
    public  Manager(String nameIn, String ssnIn) {
        ...
        //Remember that the super call must  be the first non-comment line
        // in the constructor
        super(nameIn, ssnIn);
    ...
    public void createObjectives() {
        ...
        System.out.println("Manager: create Objectives()");
    }
